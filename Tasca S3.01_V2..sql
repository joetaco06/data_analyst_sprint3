...
# Averiguamos el nombre de la foreign key en transaction para eliminarla y luego crear nuevamente las 
# relaciones y foreign key en la tabla transactions:
...
# Creamos la Foreign key de transactions que referencia la primary key en la tabla credit_card:
...
# Creamos la Foreign key de transactions que referencia la primary key en la tabla company:
